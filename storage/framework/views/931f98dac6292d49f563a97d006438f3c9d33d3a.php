...
<div class="table-responsive child_list display-none-view" id="child_list">
  <h4 class="" style="font-size: 16px; font-weight: 600; line-height: 26px; color: #181c32; margin-left:45%; margin-bottom:15px; margin-top:17px;"><?php echo e(get_phrase('Child List')); ?></h4>
    <table id="basic-datatable" class="table eTable eTable-2">
        <thead>
            <tr>
                <th scope="col">#</th>
...
<?php echo $__env->make('parent.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\ekattor8_2.1\Ekattor8\resources\views/parent/user/child_list.blade.php ENDPATH**/ ?>