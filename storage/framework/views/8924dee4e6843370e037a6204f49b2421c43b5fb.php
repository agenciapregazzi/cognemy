                        ...
                        <td>
                          <div class="adminTable-action">
                            ...
                            >
                              ...
                              <?php if( $key != 0): ?>
                                <?php if( auth()->user()->school_role == 1): ?>
                                  <li>
                                    <a class="dropdown-item" href="<?php echo e(route('admin.admin.menu_permission', ['id' => $admin->id])); ?>"><?php echo e(get_phrase('Admin Permission')); ?></a>
                              ...
                              <li>
                                <a class="dropdown-item" href="<?php echo e(route('admin.documents', ['id' => $admin->id])); ?>"><?php echo e(get_phrase('Documents')); ?></a>
                              </li>
                              <?php if(auth()->user()->id != $admin->id && $key != 0): ?>
                                  <?php if($admin->account_status == 'disable'): ?>
                                      <li>
                                          <a class="dropdown-item" href="javascript:;" onclick="confirmModal('<?php echo e(route('admin.account_enable', ['id' => $admin->id])); ?>', 'undefined');"><?php echo e(get_phrase('Enable')); ?></a>
                                      </li>
                                  <?php else: ?>
                                      <li>
                                          <a class="dropdown-item" href="javascript:;" onclick="confirmModal('<?php echo e(route('admin.account_disable', ['id' => $admin->id])); ?>', 'undefined');"><?php echo e(get_phrase('Disable')); ?></a>
                                      </li>
                                  <?php endif; ?>
                              <?php endif; ?>
                            </ul>
...
<?php echo $__env->make('admin.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\ekattor8_2.1\Ekattor8\resources\views/admin/admin/admin_list.blade.php ENDPATH**/ ?>