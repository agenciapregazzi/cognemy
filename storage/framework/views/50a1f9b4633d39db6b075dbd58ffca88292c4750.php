...
?>
<form method="POST" enctype="multipart/form-data" class="d-block ajaxForm" action="<?php echo e(route('admin.feedback.update_feedback', ['id' => $feedback->id])); ?>">
    <?php echo csrf_field(); ?> 
    <div class="fpb-7">
...
<?php /**PATH D:\xampp\htdocs\ekattor8_2.1\Ekattor8\resources\views/admin/feedback/edit_feedback.blade.php ENDPATH**/ ?>