    ...
    <div class="container-xl">
        <div class="row align-items-center">
            <div class="col-lg-2 col-md-6 col-sm-6 col-5">
                <!-- Logo  -->
                <div class="logo">
                    <a href="#"><img src="<?php echo e(asset('assets/uploads/logo/'.get_settings('front_logo'))); ?>" width="200px"
                        alt="..."></a> 
                </div>
            </div>
...
<?php echo $__env->make('frontend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\ekattor8_2.1\Ekattor8\resources\views/frontend/landing_page.blade.php ENDPATH**/ ?>