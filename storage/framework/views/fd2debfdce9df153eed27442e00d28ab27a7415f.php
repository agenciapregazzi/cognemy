                ...
                <div class="col-md-11 pb-3">
                    <div class="eForm-layouts">
                        ...
                        <form method="POST" enctype="multipart/form-data" class="d-block ajaxForm" action="<?php echo e(route('superadmin.system.update')); ?>">
                            ...
                            <div class="fpb-7">
                                <label for="features_title" class="eForm-label"><?php echo e(get_phrase('Features Title')); ?></label>
                                <input type="text" class="form-control eForm-control" value="<?php echo e(get_settings('features_title')); ?>" id="features_title" name = "features_title" required>
                            </div>
                            <div class="fpb-7">
                                <label for="features_subtitle" class="eForm-label"><?php echo e(get_phrase('Features Subtitle')); ?></label>
                                <input type="text" class="form-control eForm-control" value="<?php echo e(get_settings('features_subtitle')); ?>" id="features_subtitle" name = "features_subtitle" required>
                            </div>
                            ...
                            <div class="fpb-7">
                                <div class="form-check form-switch" style="background-color: #00feff14; display: inline-flex; padding: 11px 12px 5px 49px; border-radius: 10px; color: #fff;">
                                    ...
                                    value="Yes"
                                    <?php if(get_settings('recaptcha_switch_value') == 'Yes'): ?> checked <?php endif; ?> />
                                    
                                    <label class="eForm-label position-relative" style="margin-left: 10px;" for="flexSwitchCheckDefault"><?php echo e(get_phrase('Recaptcha')); ?>
                            ...
                            <div class="recaptcha_key_div" id="recaptcha_key_div">
                                ...
                                <div class="fpb-7">
                                    <label for="recaptcha_site_key" class="eForm-label"><?php echo e(get_phrase('Recaptcha Site Key')); ?></label>
                                    <input type="text" class="form-control eForm-control" value="<?php echo e(get_settings('recaptcha_site_key')); ?>" id="recaptcha_site_key" name = "recaptcha_site_key" placeholder="Recaptcha Site Key" >
                                </div>
                                <div class="fpb-7">
                                    <label for="recaptcha_secret_key" class="eForm-label"><?php echo e(get_phrase('Recaptcha Secret Key')); ?></label>
                                    <input type="text" class="form-control eForm-control" value="<?php echo e(get_settings('recaptcha_secret_key')); ?>" id="recaptcha_secret_key" name = "recaptcha_secret_key" placeholder="Recaptcha Secret Key">
                                </div>
                            </div>
                    ...
                    <div class="eForm-file">
                        <div class="export-btn-area">
                            <div class="export-btn-area d-flex justify-content-md-end">
                              <a href="javascript:;" class="export_btn" onclick="rightModal('<?php echo e(route('superadmin.settings.frontendFeaturesCreate')); ?>', 'Create Frontend Features')"><i class="bi bi-plus"></i><?php echo e(get_phrase('Add Frontend Features')); ?></a>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <?php $__currentLoopData = $frontendFeatures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $frontendFeature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-3">
                                ...
                                <div class="eCard" style="padding: 12px;">
                                    <form method="POST" enctype="multipart/form-data" class="d-block ajaxForm" action="<?php echo e(route('superadmin.system.frontFeaUpdate',['id' => $frontendFeature->id])); ?>">
                                        <?php echo csrf_field(); ?> 
                                        <div class="form-row">
                                            <div class="fpb-7">
                                                <label for="features_list_title" class="eForm-label"><?php echo e(get_phrase('Features List Title')); ?></label>
                                                <input type="text" class="form-control eForm-control" id="features_list_title" name = "title" value="<?php echo e($frontendFeature->title); ?>">
                                            </div>
                                            <div class="fpb-7">
                                                <label for="features_list_description" class="eForm-label"><?php echo e(get_phrase('Short Description')); ?></label>
                                                <textarea class="form-control eForm-control"  id="features_list_description" name = "description" placeholder=""><?php echo e($frontendFeature->description); ?></textarea>
                                            </div>
                                            <div class="fpb-7">
                                                <label for="features_subtitle" class="eForm-label"><?php echo e(get_phrase('Features List Image')); ?></label>
                                                <input type="text" name="icon" class="eForm-control form-control icon-picker" placeholder="<?php echo e(get_phrase('Features List Icon')); ?>" value="<?php echo e($frontendFeature->icon); ?>">
                                            </div>
                                        </div>
                                        <div class="featuresBtn d-flex justify-content-between">
                                            <button type="submit" class="btn-form" style="margin-right: 10px;"><?php echo e(get_phrase('Update')); ?></button>
                                            <div class="btn-form" style="background-color:brown; ">
                                                <a  style="color: #fff; display: flex;
                                                justify-content: center; padding-top: 6px; margin-left: 10px;" href="javascript:;"onclick="confirmModal('<?php echo e(route('superadmin.system.frontendFeaturesDlt', $frontendFeature['id'])); ?>', 'undefined');">Delete</a> 
                                            </div> 
                                        </div>  
                                    </form>
                                </div>
                        ...
                        <form method="POST" enctype="multipart/form-data" class="d-block ajaxForm" action="<?php echo e(route('superadmin.system.update')); ?>">
                            ...
                            <div class="row">
                                <div class="col-md-3 text-center">
                                    <label class="col-form-label" for="example-fileinput"><?php echo e(get_phrase('Frontend logo')); ?></label>
                                    <div class="eCard d-block text-center bg-light">
                                        <img src="<?php echo e(asset('assets/uploads/logo/'.get_settings('front_logo'))); ?>" class="mx-4 my-5" width="200px"
                                            alt="...">
...
<?php echo $__env->make('superadmin.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\ekattor8_2.1\Ekattor8\resources\views/superadmin/settings/website_settings.blade.php ENDPATH**/ ?>