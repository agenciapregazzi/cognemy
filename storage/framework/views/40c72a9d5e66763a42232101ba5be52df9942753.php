<form method="POST" enctype="multipart/form-data" class="d-block ajaxForm" action="<?php echo e(route('teacher.feedback.upload_feedback')); ?>">
    <?php echo csrf_field(); ?> 
    <div class="fpb-7">
...
<?php /**PATH D:\xampp\htdocs\ekattor8_2.1\Ekattor8\resources\views/teacher/feedback/create_feedback.blade.php ENDPATH**/ ?>