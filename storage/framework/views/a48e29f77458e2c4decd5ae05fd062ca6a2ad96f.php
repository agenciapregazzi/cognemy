            ...
            <div class="row">
                <div class="col-12">
                    <div class="eSection-wrap pb-3">
                        <div class="title">
                            <h3 class="mb-2"><?php echo e(get_phrase(' Important Notice: Your Account Has Been Disabled')); ?></h3>
                            <p>Dear <?php echo e(auth()->user()->name); ?>,</p>
                            <p><?php echo e(get_phrase('We regret to inform you that your account with')); ?> <?php echo e(DB::table('schools')->where('id', auth()->user()->school_id)->value('title')); ?><?php echo e(get_phrase(' has been disabled effective immediately')); ?>.</p>
                        </div>
                        
                        
                        <h3 class="mb-2" style="font-size: 15px; color:#181c32;"><?php echo e(get_phrase('What this means for you')); ?>:</h3>
                        <ul>
                            <p class="column-title"><?php echo e(get_phrase('You will no longer be able to access your account.')); ?></p>
                            <p class="column-title"><?php echo e(get_phrase('All services and features associated with your account are now inaccessible.')); ?></p>
                            <p class="column-title "><?php echo e(get_phrase('Any active subscriptions or services have been terminated.')); ?></p>
                        </ul>
...
<?php /**PATH D:\xampp\htdocs\ekattor8_2.1\Ekattor8\resources\views/accountant/account_disable.blade.php ENDPATH**/ ?>